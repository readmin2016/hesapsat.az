...
<section class="content">
      ...
      <div class="card-body">
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-8">
                <div class="card">
                  <div class="card-header"><h5 style="font-weight:600"><i data-feather="plus" class="iconFeather"></i> Yeni V.I.P üye ekle</h5></div>
                  <div class="card-body">
                    <div id="alert-danger">
                      
                    </div>
                    <form action="" id="formRegisterVip" method="post">
