      ...
      <div class="container-fluid">
       ...
       <div class="card">
		  <div class="card-header">
		    ...
		    <h5>Kredi kartı/İninal kartı komisyon ayarları</h5>
		  </div>
		  <div class="card-body">
        <div class="row justify-content-md-center">
          <div class="col-md-6">
            
            <h4>Kredi kartı/İninal kartı komisyon belirleyin</h4>
            <br>
            <?php
              $rows = $this->db->where(array('pay_id'=>1))->get('payment')->result();
              foreach ($rows as $p) {
                # code...
              }
            ?>
