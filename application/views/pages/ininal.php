		...
		<div class="row">
			<div class="col-lg-9 margin-bottom-1x" style="padding-left:10px; padding-right:10px;">
				 <div class="card">
					...
					<h6><i data-feather="pocket" style="margin-top:-1px;"></i> İninal cüzdan ile ödeme yapıyorsunuz...</h6>
					</div>
					<div class="card-body">
					...
					<br><br>
					<div class="card">
					<div class="card-header bg-info text-white">İninal Numaramız</div>
					<div class="card-body">
					...
					<form action="javascript:void(0)" name="form" method="post" id="odbildir-form">
					<div class="col-md-12">
					...
					<button id="odbildir-button" type="submit" class="btn btn-success btn-sm btn-rounded" style="background:#55e386;border-color:#55e386;">
						...
						<input type="hidden" name="bank_select" value="Ininal-1311489378">
