...
<div class="head_panel">
	<div class="container">
		...
		<span><a href="<?php echo base_url()?>">Ana Sayfa </a> > Hakkimizda</span>
	</div>
</div>
...
<div class="container">
	<div class="content">
		...
		<h2 style="text-align: left;">Hesap alışverişlerinde güvenilir tek adres...</h2>
		<p>
			Dijital dünya her geçen gün hayatımızda daha fazla yer edinmeye hızla devam ediyor. Sosyal medya platformları, eğitim ve eğlence platformları artık insanların günlük yaşamında en çok zaman ayırdığı unsurların başında geliyor. Hatta bu dünya o kadar çok büyüdü ki, bu işlerle uğraşan insanlar çok ciddi gelirler elde edebiliyor. Bu aşamada bu hesapların da bir piyasası ve doğal olarak da bir pazarı oluşmuştur. Hesap alım satım işlemleri her geçen gün dijital dünyanın büyümesiyle beraber büyümektedir. 
		</p>
		<br>
		<p>
			Hesapsat.net olarak biz, sosyal medya hesaplarını satmak isteyen üyelerimiz ile hesap satın almak isteyen üyelerimizi güvenli bir web ortamında buluşturuyor ve alışverişin güvenle gerçekleşmesini sağlıyoruz. 7 gün 24 saat size hizmet veren güler yüzlü ekibimizle her zaman yanınızdayız.
		</p>
